...
function App() {
  ...
  useEffect(()=> {
    // console.log("change to red", isRed);
    // console.log("change to orange", isOrange);
    // console.log("change to brown", isBrown);
    // console.log("change, to light brown", isLightBrown);
    // console.log("change to yellow", isYellow);
    const colors = []
